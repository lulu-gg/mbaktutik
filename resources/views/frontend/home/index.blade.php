...
<section class="cs-hero cs-style4 cs-bg cs-center" data-src="{{ asset('frontend/assets/img/hero_bg4.jpg') }}">
        ...
        <div class="cs-hero_in">
            <div class="cs-hero_in_left">
                <div class="cs-hero_text">
                    ...
                    <div class="cs-hero_subtitle cs-medium cs-white_color">Tired of missing out on unforgettable experiences? Rive Ticket is your gateway to epic events! Visit Rive Ticket today and transform your bucket list into reality!</div>
                            ...
                            <div class="cs-slide">
                                <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                                    ...
                                    <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                                        <img src="{{ asset('frontend/assets/img/general/general_16.jpg') }}" alt="Image" class="cs-zoom_item">
                                    </a>
                                    <div class="cs-card_info">
                                        ...
                                        <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">{{ $item->name }}</a>
                                        </h3>
                                        <div class="cs-card_price">Start Date: <b class="cs-primary_color">{{ date('d M, H:i:s',
                                                strtotime($item->start_date)); }}</b>
                                            <div class="cs-card_price">End Date: <b class="cs-primary_color">{{ date('d M, H:i:s',
                                                    strtotime($item->end_date)); }}</b>
                                            </div>
                                            <div class="cs-card_price">
                            
                                                <span class="badge badge-warning" style="background-color: rgba(255, 229, 80, 0.801)">On
                                                    Going</span>
                                            ...
                                            <div class="cs-card_footer">
                                                <a href="{{ url('/events/'. $item->seo) }}"><span class="cs-card_btn_2"><span>Buy
                                                            Ticket</span></span></a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cs-slider_arrows cs-style1 cs-center cs-hidden_mobile">
                        <div class="cs-left_arrow cs-center cs-box_shadow">
                            <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                ...
                                <path d="M13.0269 7.55957H0.817552" stroke="currentColor" stroke-width="1.16474"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M6.92188 1.45508L0.817222 7.55973L6.92188 13.6644" stroke="currentColor"
                                    stroke-width="1.16474" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div class="cs-right_arrow cs-center cs-box_shadow">
                            <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.816895 7.55957H13.0262" stroke="currentColor" stroke-width="1.16474"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M6.92188 1.45508L13.0265 7.55973L6.92188 13.6644" stroke="currentColor"
                                    stroke-width="1.16474" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    </div>
                ...
                <div class="cs-slider_wrapper">
                    ...
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                                <img src="{{ asset('frontend/assets/img/general/general_14.jpg') }}" alt="Image"
                                    class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
                                ...
                                <span class="badge badge-warning" style="background-color: rgba(255, 229, 80, 0.801)">On Going</span>
                                ...
                                <div class="cs-card_footer">
                                    ...
                                    <a href="{{ url('/events/'. $item->seo) }}"><span class="cs-card_btn_2"><span>Buy Ticket</span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="cs-slider_wrapper">
                    ...
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                                <img src="{{ asset('frontend/assets/img/general/general_12.jpg') }}" alt="Image" class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
...
<section>
    <div class="container">
        <div class="cs-height_95 cs-height_lg_70"></div>
        <h2 class="cs-section_heading cs-style1 text-center">How To Buy Ticket</h2>
        <div class="cs-height_45 cs-height_lg_45"></div>
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="cs-iconbox cs-style1 cs-white_bg">
                    <div class="cs-iconbox_icon">
                        <svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="url(#paint0_linear_1360_6767)"></path>
                            <defs>
                                <linearGradient id="paint0_linear_1360_6767" x1="0.84375" y1="0.290039" x2="63.2046"
                                    y2="31.8753" gradientUnits="userSpaceOnUse">
                    ...
                    <h2 class="cs-iconbox_title">Find Your Adventure!</h2>
                    <div class="cs-iconbox_subtitle">Head over to the Rive Ticket website. <br>
                    Explore the exciting events on offer. Use the search bar or browse by category to find your perfect match.
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="cs-iconbox cs-style1 cs-white_bg">
                    <div class="cs-iconbox_icon">
                        <svg width="63" height="53" viewBox="0 0 63 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="url(#paint0_linear_1360_6757)"></path>
                            <defs>
                                <linearGradient id="paint0_linear_1360_6757" x1="2.7832" y1="0.290039" x2="68.2844"
                                    y2="36.4949" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#FC466B"></stop>
                                    <stop offset="1" stop-color="#3F5EFB"></stop>
                                </linearGradient>
                            </defs>
                    ...
                    <h2 class="cs-iconbox_title">Select Your Seats!</h2>
                    <div class="cs-iconbox_subtitle">Click on the event you want to attend. <br>
                    Choose your preferred seating option from the interactive seating chart. You'll see real-time availability and pricing
                    for each section.
                    </div>
                </div>
                <div class="cs-height_30 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="cs-iconbox cs-style1 cs-white_bg">
                    <div class="cs-iconbox_icon">
                        <svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="url(#paint0_linear_1360_6784)"></path>
                            <defs>
                                <linearGradient id="paint0_linear_1360_6784" x1="0.775391" y1="0.290039" x2="63.1273"
                                    y2="31.863" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#FC466B"></stop>
                                    <stop offset="1" stop-color="#3F5EFB"></stop>
                                </linearGradient>
                            </defs>
                    ...
                    <h2 class="cs-iconbox_title">Secure Your Tickets!</h2>
                    <div class="cs-iconbox_subtitle">Once you've chosen your seats, click "Add to Cart". <br>
                    Review your order details and ensure everything is correct.<br>
                    Proceed to checkout and create a new account or sign in to your existing one.</div>
                </div>
                <div class="cs-height_30 cs-height_lg_30"></div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="cs-iconbox cs-style1 cs-white_bg">
                    <div class="cs-iconbox_icon">
                        <svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="url(#paint0_linear_1360_6776)"></path>
                            <defs>
                                <linearGradient id="paint0_linear_1360_6776" x1="0.863281" y1="0.290039" x2="63.1466"
                                    y2="31.7697" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#FC466B"></stop>
                                    <stop offset="1" stop-color="#3F5EFB"></stop>
                                </linearGradient>
                            </defs>
                    ...
                    <h2 class="cs-iconbox_title">Checkout and Confirmation!</h2>
                    <div class="cs-iconbox_subtitle">Choose your preferred payment method and follow the secure payment process. <br>
                    Once your payment is confirmed, you'll receive a confirmation email with your tickets attached (electronically or
                    printable).</div>
                </div>
                <div class="cs-height_30 cs-height_lg_30"></div>
            </div>
...
<section>
    <div class="container">
        <h2 class="cs-section_heading cs-style1 text-center">Our Sponsors</h2>
        <div class="cs-height_45 cs-height_lg_45"></div>
    </div>
    <div class="cs-moving_carousel_1">
        ...
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg" style="background-color: white; width:150px;"><img src="{{ asset('uploads/sponsors/' . $item->logo) }}"
