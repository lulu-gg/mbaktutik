            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        ...
                        <div class="cs-iconbox_subtitle">Head over to the Rive Ticket website. <br>
                            Explore the exciting events on offer. Use the search bar or browse by category to find your
                            perfect match.
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        ...
                        <div class="cs-iconbox_subtitle">Click on the event you want to attend. <br>
                            Choose your preferred seating option from the interactive seating chart. You'll see real-time
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        ...
                        <div class="cs-iconbox_subtitle">Choose your preferred payment method and follow the secure payment
                            process. <br>
                            Once your payment is confirmed, you'll receive a confirmation email with your tickets attached
                            (electronically or
                            printable).</div>
                    </div>
                    <div class="cs-height_30 cs-height_lg_30"></div>
