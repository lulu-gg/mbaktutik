                                ...
                                @foreach ($upcomingEvents as $item)
                                    <div class="cs-slide">
                                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                                            ...
                                            <a href="{{ url('/events/detail/' . $item->slug) }}" class="cs-card_thumb cs-zoom_effect" title="{{ $item->name }}">
                                                <img src="{{ $item->banner_path }}" alt="{{ $item->name }} Image" class="cs-zoom_item" style="width: 100%; height: 150px; object-fit: cover;">
                                            </a>
                                            <div class="cs-card_info">
                                                <a href="#" class="cs-avatar cs-white_bg">
                                                    <img src="{{ $item->organizer->logo_path }}" alt="{{ $item->organizer->company_name }} Logo">
                                                ...
                                                <div class="cs-card_price">Start Date: <b class="cs-primary_color">{{ date('d M, H:i:s', strtotime($item->start_date)) }}</b></div>
                                                <div class="cs-card_price">End Date: <b class="cs-primary_color">{{ date('d M, H:i:s', strtotime($item->end_date)) }}</b></div>
                                                <hr>
                        ...
                        @foreach ($ongoingEvents as $item)
                            <div class="cs-slide">
                                <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                                    ...
                                    <a href="{{ url('/events/detail/' . $item->slug) }}"
                                        class="cs-card_thumb cs-zoom_effect" title="{{ $item->name }}">
                                        <img src="{{ $item->thumbnail_path }}" alt="{{ $item->name }} Image" class="cs-zoom_item" style="width: 100%; height: 200px; object-fit: cover;">
                                    </a>
                                    <div class="cs-card_info">
                                        <a href="#" class="cs-avatar cs-white_bg">
                                            <img src="{{ $item->organizer->logo_path }}" alt="{{ $item->organizer->company_name }} Logo">
                                        ...
                                        <div class="cs-card_price">Start Date: <b
                                                class="cs-primary_color">{{ date('d M, H:i:s', strtotime($item->start_date)) }}</b></div>
                                        <div class="cs-card_price">End Date: <b
                                                class="cs-primary_color">{{ date('d M, H:i:s', strtotime($item->end_date)) }}</b></div>
                                        <hr>
                                        <div class="cs-card_footer">
                        ...
                        @foreach ($pastEvents as $item)
                            <div class="cs-slide">
                                <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                                    ...
                                    <a href="{{ url('/events/detail/' . $item->slug) }}"
                                        class="cs-card_thumb cs-zoom_effect" title="{{ $item->name }}">
                                        <img src="{{ $item->thumbnail_path }}" alt="{{ $item->name }} Image" class="cs-zoom_item">
                                    </a>
                                    <div class="cs-card_info">
                    ...
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        <div class="cs-iconbox_icon">
                            <svg width="63" height="53" viewBox="0 0 63 53" fill="none"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_1360_6757" x1="2.7832" y1="0.290039"
                                        x2="68.2844" y2="36.4949" gradientUnits="userSpaceOnUse">
                        ...
                        <h2 class="cs-iconbox_title">Chose Your Event!</h2>
                        <div class="cs-iconbox_subtitle">Explore the exciting events available. Use the search bar or
                            browse by category to find your perfect match.
                        </div>
                    </div>
                    ...
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        <div class="cs-iconbox_icon">
                            <svg width="53" height="53" viewBox="0 0 53 53" fill="none"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_1360_6784" x1="0.775391" y1="0.290039"
                                        x2="63.1273" y2="31.863" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#FC466B"></stop>
                                        <stop offset="1" stop-color="#3F5EFB"></stop>
                                    </linearGradient>
                                </defs>
                        ...
                        <h2 class="cs-iconbox_title">Fill Purchase Form!</h2>
                        <div class="cs-iconbox_subtitle">
                            Provide the required information in the purchase form to proceed with your order.
                        </div>
                    </div>
                    <div class="cs-height_30 cs-height_lg_30"></div>
                </div>
                    ...
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        <div class="cs-iconbox_icon">
                            <svg width="53" height="53" viewBox="0 0 53 53" fill="none"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_1360_6767" x1="0.84375" y1="0.290039"
                                        x2="63.2046" y2="31.8753" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#FC466B"></stop>
                                        <stop offset="1" stop-color="#3F5EFB"></stop>
                                    </linearGradient>
                                </defs>
                        ...
                        <h2 class="cs-iconbox_title">Payment!</h2>
                        <div class="cs-iconbox_subtitle">
                            Select your preferred payment method from the available options and complete the transaction
                            securely.
                        </div>
                    </div>
                    <div class="cs-height_30 cs-height_lg_30"></div>
                    ...
                    <div class="cs-iconbox cs-style1 cs-white_bg">
                        <div class="cs-iconbox_icon">
                            <svg width="53" height="53" viewBox="0 0 53 53" fill="none"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_1360_6776" x1="0.863281" y1="0.290039"
                                        x2="63.1466" y2="31.7697" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#FC466B"></stop>
                                        <stop offset="1" stop-color="#3F5EFB"></stop>
                                    </linearGradient>
                                </defs>
                        ...
                        <h2 class="cs-iconbox_title">Purchase Completed!</h2>
                        <div class="cs-iconbox_subtitle">
                            Once your purchase is confirmed, an electronic ticket (E-Ticket) will be sent to the email
                            address you provided during the purchase process.
                        </div>
                    </div>
                    <div class="cs-height_30 cs-height_lg_30"></div>
                </div>
        ...
        <div class="container">
            ...
            <div class="carousel-sponsor">
                @foreach ($sponsor as $item)
                    <img src="{{ asset('uploads/sponsors/' . $item->logo) }}" alt="{{ $item->name }} Logo" style="margin:10px"
