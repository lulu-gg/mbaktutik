    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-md-8 offset-xl-3 offset-md-2">
                <form class="cs-form_card cs-style1 cs-box_shadow cs-white_bg" method="POST" action="{{ url('/login') }}">
                    @csrf
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 mb-3">
                        <div class="cs-iconbox cs-style3 cs-box_shadow cs-white_bg h-100">
                            <div class="cs-iconbox_text">
                                <h5 class="cs-form_title">Login Event Organizer</h5>
                                <p>Access your personalized dashboard to manage your events.</p>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-6 mb-3">
                        <div class="cs-iconbox cs-style3 cs-box_shadow cs-white_bg h-100">
                            <div class="cs-iconbox_text">
                                ...
                                <p>Sign up now to start creating and managing your events.</p>
                            </div>
