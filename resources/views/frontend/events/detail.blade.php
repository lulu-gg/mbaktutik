        ...
        <div class="col-lg-6">
            <div class="slider-for">
                <div class="slider-item">
                    <div class="cs-slider_thumb_lg"><img src="{{ asset('frontend/assets/img/explore_lg_1.jpg') }}" alt=""></div>
                </div>
                <div class="slider-item">
                    <div class="cs-slider_thumb_lg"><img src="{{ asset('frontend/assets/img/explore_lg_1.jpg') }}" alt=""></div>
                </div>
            ...
            <div class="slider-nav">
                <div class="slider-item">
                    <div class="cs-slider_thumb_sm"><img src="{{ asset('frontend/assets/img/explore_sm_1.jpg') }}" alt=""></div>
                </div>
                <div class="slider-item">
                    <div class="cs-slider_thumb_sm"><img src="{{ asset('frontend/assets/img/explore_sm_2.jpg') }}" alt=""></div>
                </div>
                <div class="slider-item">
                    <div class="cs-slider_thumb_sm"><img src="{{ asset('frontend/assets/img/explore_sm_3.jpg') }}" alt=""></div>
                </div>
                <div class="slider-item">
                    <div class="cs-slider_thumb_sm"><img src="{{ asset('frontend/assets/img/explore_sm_1.jpg') }}" alt=""></div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="cs-author_card cs-white_bg cs-box_shadow">
                        <div class="cs-author_img"><img src="{{ asset('frontend/assets/img/avatar/avatar_1.png') }}" alt=""></div>
                ...
                <div class="col-xl-6">
                    <div class="cs-author_card cs-white_bg cs-box_shadow">
                        <div class="cs-author_img"><img src="{{ asset('frontend/assets/img/avatar/avatar_21.png') }}" alt=""></div>
                        <div class="cs-author_right">
                            <h3>Audiography</h3>
                ...
                <div class="cs-tab_content">
                        ...
                        <ul class="cs-activity_list cs-mp0">
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_21.png') }}" alt="">
                                    </div>
                            ...
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_22.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
                            ...
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_23.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
                            ...
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_24.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
                    ...
                    <div id="tab_two" class="cs-tab">
                        <ul class="cs-activity_list cs-mp0">
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_27.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
                            ...
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_28.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
                            ...
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_25.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
                            ...
                            <li>
                                <div class="cs-activity cs-white_bg cs-type1">
                                    <div class="cs-activity_avatar"><img src="{{ asset('frontend/assets/img/avatar/avatar_26.png') }}" alt="">
                                    </div>
                                    <div class="cs-activity_right">
