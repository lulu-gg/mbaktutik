                ...
                <div class="cs-filter_widget">
                    ...
                    <div class="cs-filter_toggle_body">
                        <ul>
                            <li>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="collection" id="Audioglyphs"
                                        checked>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <div class="cs-card_info">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Art work #2134</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <div class="cs-card_info">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Cool octopus traveling</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <div class="cs-card_info">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Octopus eating icecrem</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <div class="cs-card_info">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Panda with fish</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <div class="cs-card_info">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Kawaii-bubble-tea</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/6.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_12.png') }}" alt="Avatar">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Cute monsters hallo</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/7.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_13.png') }}" alt="Avatar">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Cat-mascot-character</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/8.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_12.png') }}" alt="Avatar">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Small kid with orange</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/9.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_13.png') }}" alt="Avatar">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Digital Cat Illustration</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/10.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_12.png') }}" alt="Avatar">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Fictional character</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/11.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_13.png') }}" alt="Avatar">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/12.jpg') }}" alt="Image" class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                                <img src="{{ asset('frontend/assets/img/avatar/avatar_13.png') }}" alt="Avatar">
