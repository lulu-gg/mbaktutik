...
<div class="container">
    <div class="cs-cover_photo cs-bg" data-src="{{ asset('frontend/assets/img/cover-photo.jpg') }}">
    ...
    <div class="cs-prifile_wrap">
        <div class="cs-profile_left">
            <div class="cs-profile_sidebar cs-white_bg cs-box_shadow">
                <div class="cs-profile_info">
                    <div class="cs-profile_pic"><img src="{{ asset('frontend/assets/img/avatar/avatar_29.png') }}"
                            alt=""></div>
                ...
                <ul class="cs-profile_nav cs-mp0">
                            ...
                            <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                                ...
                                <defs>
                                    <clipPath id="clip0_1353_5407">
                                        <rect width="18" height="18" fill="white" transform="translate(0.960938)" />
                                    </clipPath>
                                </defs>
                            </svg>
                    ...
                    <li>
                        <a href="{{ url('/account/myevents') }}" class="active">
                    ...
                    <li>
                        <a href="{{ url('/account/organizer/events/create') }}">
        ...
        <div class="cs-profile_right">
            <div class="cs-height_30 cs-height_lg_30"></div>
            <h2 class="cs-section_heading cs-style1">My Events</h2>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/1.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/2.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Cool octopus traveling</a>
                            </h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/3.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Octopus eating icecrem</a>
                            </h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/4.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/5.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/6.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/7.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Cat-mascot-character</a>
                            </h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                        ...
                        <a href="{{ url('/events/detail') }}" class="cs-card_thumb cs-zoom_effect">
                            <img src="{{ asset('frontend/assets/img/explore/8.jpg') }}" alt="Image"
                                class="cs-zoom_item">
                        </a>
                        <div class="cs-card_info">
                            <a href="#" class="cs-avatar cs-white_bg">
                            ...
                            <h3 class="cs-card_title"><a href="{{ url('/events/detail') }}">Small kid with orange</a>
                            </h3>
