    ...
    <section class="cs-page_head cs-bg" data-src="{{ asset('frontend/assets/img/page_head_bg.svg') }}">
        <div class="container">
            <div class="text-center">
                <h1 class="cs-page_title">Contact</h1>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="cs-contact_info text-center">
                            <div class="cs-contact_icon">
                                <svg width="39" height="39" viewBox="0 0 39 39" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_1448_14685" x1="38.6309" y1="0.724609"
                                            x2="-6.93527" y2="23.7985" gradientUnits="userSpaceOnUse">
                            ...
                            <p class="cs-contact_text">{{ $generalParameter->phone }}</p>
                        </div>
                        <div class="cs-contact_info text-center">
                            <div class="cs-contact_icon">
                                <svg width="40" height="39" viewBox="0 0 40 39" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_1448_14689" x1="4.16211" y1="3.89258"
                                            x2="40.3952" y2="24.2752" gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#FC466B" />
                                            <stop offset="1" stop-color="#3F5EFB" />
                                        </linearGradient>
                                    </defs>
                            ...
                            <p class="cs-contact_text">{{ $generalParameter->email }}</p>
                        </div>
                        <div class="cs-contact_info text-center">
                            <div class="cs-contact_icon">
                                <svg width="41" height="39" viewBox="0 0 41 39" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_1448_14701" x1="4.91602" y1="0.543945"
                                            x2="45.0587" y2="17.2727" gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="#FC466B" />
                                            <stop offset="1" stop-color="#3F5EFB" />
                                        </linearGradient>
                                    </defs>
                            ...
                            <h3 class="cs-contact_title">Location</h3>
                            <p class="cs-contact_text">{{ $generalParameter->address }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="cs-contact_box">
                    <div class="cs-section_heading cs-style4">
                        <h2 class="cs-section_title">Drop Us Your Message</h2>
                        <p class="cs-section_subtitle">Freely contact with us anytime. We're available here for you.</p>
                    </div>
                    <div class="cs-height_45 cs-height_lg_45"></div>
                    <form class="cs-contact_form" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="cs-form_field_wrap">
                                    <input type="text" class="cs-form_field" placeholder="Full Name" name="name"
                                        required>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="cs-form_field_wrap">
                                    <input type="email" class="cs-form_field" placeholder="Your Email" name="email"
                                        required>
                                </div>
                                <div class="cs-height_20 cs-height_lg_20"></div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="cs-form_field_wrap">
                                    <textarea cols="30" rows="5" placeholder="Message..." class="cs-form_field" name="message" required></textarea>
                                </div>
                                <div class="cs-height_20 cs-height_lg_20"></div>
                            </div>
