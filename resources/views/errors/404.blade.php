...
<html lang="en" class="light-style" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('sneat-pro/assets/') }}" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('sneat-pro/assets/vendor/css/core.css') }}"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('sneat-pro/assets/vendor/css/theme-default.css') }}"
